...
export const SMPIA9_FULL_ROSTER: Omit<Student, 'id' | 'teacherId'>[] = [
  ...
  { nis: '4309-2223061', nisn: '0098765080', name: 'Abdullah Azzam Ramadhan', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0811-2233-4455' },
  { nis: '4309-2223062', nisn: '0098765081', name: 'Yasmin Nur Azizah', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0812-4455-6688' },
  { nis: '4309-2223063', nisn: '0098765082', name: 'Salman Al-Hakim Ramadhan', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0812-5566-7788' },
  { nis: '4309-2223064', nisn: '0098765083', name: 'Naila Zahra Al-Munawwarah', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0878-3344-5566' },
  { nis: '4309-2223065', nisn: '0098765084', name: 'Muhammad Farhan Al-Ghifari', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0813-2211-4433' },
  { nis: '4309-2223066', nisn: '0098765085', name: 'Aisyah Putri Azzahra', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0858-7788-9900' },
  { nis: '4309-2223067', nisn: '0098765086', name: 'Fatih Rizky Pratama', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0812-9988-1122' },
  { nis: '4309-2223068', nisn: '0098765087', name: 'Ghaniyya Salma Maulida', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0813-4455-2233' },
  { nis: '4309-2223069', nisn: '0098765088', name: 'Hafizh Al-Khairi Syakir', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0856-2233-4455' },
  { nis: '4309-2223070', nisn: '0098765089', name: 'Hana Auliya Rahmah', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0818-5566-7788' },
  { nis: '4309-2223071', nisn: '0098765090', name: 'Ibnu Sina Al-Faruq', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0877-3344-5566' },
  { nis: '4309-2223072', nisn: '0098765091', name: 'Kayla Salsabila Putri', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0812-7788-9911' },
  { nis: '4309-2223073', nisn: '0098765092', name: 'M. Dzaky Ar-Rasyid', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0813-1122-3355' },
  { nis: '4309-2223074', nisn: '0098765093', name: 'Maryam Syahidah', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0852-4455-6677' },
  { nis: '4309-2223075', nisn: '0098765094', name: 'Nabil Ahmad Faiz', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0816-7788-9900' },
  { nis: '4309-2223076', nisn: '0098765095', name: 'Qonita Lathifah Zahra', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0817-2233-4466' },
  { nis: '4309-2223077', nisn: '0098765096', name: 'Rayhan Malik Al-Farisi', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0819-5566-7799' },
  { nis: '4309-2223078', nisn: '0098765097', name: 'Syifa Khairun Nisa', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0812-8899-0022' },
  { nis: '4309-2223079', nisn: '0098765098', name: 'Umar Abdul Aziz', gender: 'L', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0813-3344-5577' },
  { nis: '4309-2223080', nisn: '0098765099', name: 'Zahira Talita Humaira', gender: 'P', className: '9C', targetJuz: 'Juz 28, 29, 30', targetSurahCount: 59, parentPhone: '0857-6677-8800' },
];
